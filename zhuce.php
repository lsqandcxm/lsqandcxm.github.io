...
<body>
	<header class="mui-bar mui-bar-nav" style="background:#272727;">
		...
		<h1 class="mui-title" style="color: #fff;">好利来——注册</h1>
	</header>
	<div class="mui-content">
		<div class="mui-row" style="padding-top: 15px;">
			<center>
				<div class="mui-col-sm-10 mui-col-xs-10">
					<form class="mui-input-group" action="rezhuce.php" method="POST" enctype='multipart/form-data'>
					    ...
					    <div class="mui-input-row">
				            <label>确认密码</label>
				            <input type="password" class="mui-input-password" name="repassword">
					    </div>
					    <div style="padding-top: 15px;">
					    	<button type="submit" class="mui-btn mui-btn-primary mui-btn-block">注册</button>
					    	<a href='wangji.php' class="mui-pull-left" style="color: red;">忘记密码?</a>
					    	<a href='login.php' class="mui-pull-right">登录</a>
					    </div>
					</form>
				</div>
			</center>
